...
# ── Tu reto ─────────────────────────────────────────────────
#
# Este paso NO tiene huecos ___. Funciona tal cual.
# Tu misión:
#
...
#        "Usa la columna nps de df_members para calcular el
#         NPS medio por centro"
#      La primera suele arreglarse al segundo intento. La
#      segunda no puede: la columna no existe. Mira cómo se
#      rinde el modelo.
...
#
# Al final del archivo hay un desplegable "Lo que enviamos en
# el último intento". Ábrelo tras una pregunta que haya
# fallado: messages ya no tiene dos entradas, sino cuatro o
# seis. El código que falló va como "assistant" y el error
# como "user". El modelo no recuerda nada: recibe la
# conversación entera en cada petición porque la construimos
# nosotros en esa lista.
#
...
#      valores posibles de cada columna (como hiciste en
#      paso_9). ¿Reduce los errores de "columna no
#      encontrada"?
#
